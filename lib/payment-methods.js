...
/** Solo con pago en local se pueden cambiar platos (el total aún no se ha cobrado). */
export function allowsReservationDishEdit(paymentMethod) {
  return String(paymentMethod || "") === "local";
}
